...
**Answer:**  
I used `paraphrase-multilingual-MiniLM-L12-v2`from Sentence Transform-ers. It supports both Bangla and English and provides dense, semantic embeddings ideal for
